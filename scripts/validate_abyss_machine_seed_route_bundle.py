...
CONSUMER_REF = "Dionysus:seed-route-readmodel"
...
def _validate_in_bundle_dir(
    ...
    *,
    ...
    _assert_public_registry_does_not_leak_local_roots(subject_store_root, abyss_machine_root)
    latest_registry = artifact_bundles.read_bundle_registry(registry_dir, artifact_class=EXPECTED_ARTIFACT_CLASS)
