...
This skeleton `evals/` port preserves seed-born eval pressure such as seed
surface cases, wave manifest checks, planting lineage questions, replay route
fixtures, and closure-note review cues.
